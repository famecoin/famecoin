...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "famecoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
  {"45.77.80.117", "45.77.80.117"},
  {"45.32.172.67", "45.32.172.67"},
  {"185.183.99.171", "185.183.99.171"},
  {"185.183.99.19", "185.183.99.19"},
    {"", ""},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. famecoin is probably already running."), addrBind.ToString().c_str());
        else
